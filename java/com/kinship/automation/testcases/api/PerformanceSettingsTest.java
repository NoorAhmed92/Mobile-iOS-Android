...
import com.kinship.automation.base.ApiBaseTest;
...
public class PerformanceSettingsTest extends ApiBaseTest {
	Response response;
	
	@TestRails(id="993892")
	@Description("[TestRail] Test Performance Settings")
	@Test(groups = "P0", retryAnalyzer = Retry.class)
	@Feature("PerformanceSettings")
	public void testPerformanceSettings() throws IOException {
			log.info("********* Test Case Execution started for performance settings ***********");
			String token = Utils.getValuesFromPropertiesFile("environment", "auth_token");
			APIResources resourceAPI = APIResources.valueOf("getPerformanceSettings");
