...
public class SelectDevicePage extends WhistleBasePage {
	...
	private By healthDevice = ByT.locator(By.id("Whistle Health"),By.id("device_picker_item_health") );
	...
	public boolean isSelectYourDevicePageTitleDisplayed() {
		driver.waitForElementToBeVisible(selectYourDevicePageTitle);
	...
	@Step("Verify if app back navigation is displayed")
	public boolean isAppBackNavigationDisplayed() {
		return driver.isElementPresent(navigateUpBackButton);
	}

	@Step("Verify if Whistle Switch CTA is displayed")
	public boolean isWhistleSwitchCTADisplayed() {
		return driver.isElementPresent(switchDevice);
	}

	@Step("Verify if Whistle GO Explorer CTA is displayed")
	public boolean isWhistleGoExplorerCTADisplayed() {
		return driver.isElementPresent(goExplorerDevice);
	}

	@Step("Verify if Whistle Health CTA is displayed")
	public boolean isWhistleHealthCTADisplayed() {
		return driver.isElementPresent(healthDevice);
	}
	@Step("Click on Other whistle Devices")
	public void clickOtherWhistleDevices(){
		driver.clickLocator(selectDevice);
	}

	@Step("Verify if Whistle Fit CTA is displayed")
	public boolean isWhistleFitCTADisplayed() {
		return driver.isElementPresent(fitDevice);
	}

	@Step("Verify if Whistle Go CTA is displayed")
	public boolean isWhistleGoCTADisplayed() {
		return driver.isElementPresent(goDevice);
	}
}
