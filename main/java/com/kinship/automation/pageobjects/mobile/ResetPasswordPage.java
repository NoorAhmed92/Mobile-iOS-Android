...
public class ResetPasswordPage  extends WhistleBasePage {
	...
	public String getToastMessage() {
		driver.waitForElementToBePresent(toastMessageText);
		String ele = driver.getText(toastMessageText,"Get the Reset Password toast Message");
		return ele;
	}

	@Step ("Verify Reset Password Error message with Ok button")
	public boolean isOkBtnResetPsdErrorMsgDisplayed() {
		driver.pauseExecutionFor(2);
		return driver.isElementPresent(clickOKBtn);
	}
