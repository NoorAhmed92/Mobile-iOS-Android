...
public class PetEditProfilePage  extends WhistleBasePage {
    ...
    private By petEditProfile = ByT.locator(By.id("Edit Profile"), By.xpath("//android.widget.TextView[@text='Edit Profile']"));
    ...
    private By petWeight = ByT.locator(By.id("edit pet profile - weight"), By.id("pet_profile_list_item_weight"));
    ...
    private By petSaveBtn = ByT.locator(By.id("edit pet profile - weight"), By.id("md_buttonDefaultPositive"));
    private By petWeightValue = ByT.locator(By.xpath("//XCUIElementTypeOther[@name='edit pet profile - weight']/XCUIElementTypeTextField"), By.xpath("//android.widget.LinearLayout/android.view.ViewGroup[6]/android.view.ViewGroup/android.widget.ImageView/following-sibling::android.widget.TextView[2]"));
    private By petFood = ByT.locator(By.id("edit pet profile - pet food"), By.id("pet_profile_list_item_pet_food"));
    private By toastMessage = ByT.locator(By.id(""), By.xpath("//android.widget.Toast[1]"));
    private By petAge = ByT.locator(By.id("edit pet profile - age"), By.xpath("//android.widget.TextView[@text='Age']"));
    private By petAgeYear = ByT.locator(By.xpath("//XCUIElementTypePicker/XCUIElementTypePickerWheel[1]"),By.xpath("//android.widget.NumberPicker[1]/android.widget.EditText"));
    private By petAgeMonths = ByT.locator(By.xpath("//XCUIElementTypePicker/XCUIElementTypePickerWheel[3]"),By.xpath("//android.widget.NumberPicker[2]/android.widget.EditText"));
    private By saveButton = ByT.locator(By.xpath(""),By.id("md_buttonDefaultPositive"));
    private By getUpdatedAge = ByT.locator(By.xpath("//XCUIElementTypeOther[@name='edit pet profile - age']/XCUIElementTypeTextField"),By.xpath("//android.widget.LinearLayout/android.view.ViewGroup[5]/android.view.ViewGroup/android.widget.ImageView/following-sibling::android.widget.TextView[2]"));
    private By getUpdatedPetFood = ByT.locator(By.xpath("(//XCUIElementTypeOther/XCUIElementTypeStaticText)[2]"),By.xpath("//android.widget.LinearLayout/android.view.ViewGroup[8]/android.view.ViewGroup/android.widget.ImageView/following-sibling::android.widget.TextView[2]"));
    ...
    public String selectPetStatus(String sPetStatus) throws InterruptedException {
        log.info("Selecting & Updating Pet Gender");
        log.info("sPetStatus ==> " + sPetStatus);
        if (isAndroidBS()) {
    ...
    public void editTimezoneField(String name, String index) {
        if (isAndroidBS()) {
            ...
            driver.findElement(By.xpath("//XCUIElementTypePicker/XCUIElementTypePickerWheel")).sendKeys(name);
            driver.findElement(By.xpath("//XCUIElementTypePicker/XCUIElementTypePickerWheel")).click();
    ...
    public void selectPetWeightLbs() throws InterruptedException {
        ...
        if(isAndroidBS()) {
            ...
            driver.pauseExecutionFor(2);
            driver.scrollTo(598, 1338, 598, 1414);
        }
    }
    ...
    @Step("Validating toast message")
    public String validateToastMessage() {
        driver.pauseExecutionFor(2);
        String toastMsgs = driver.findElement(toastMessage).getText();
        log.info(toastMsgs);
        return toastMsgs;

    }

    @Step("Update Pet's Weight Lbs and Kg fields as Blank")
    public void updatePetWeightLbsAndKgFieldsBlank() throws InterruptedException {
        log.info("Updating Pet's Weight Lbs and Kg fields as Blank");
        driver.findElement(petWeightInputField).clear();
    }

    public void clickOnAge(){
        driver.clickLocator(petAge);
    }

    public void enterYear(String year){
        driver.clickLocator(petAgeYear);
        driver.type(petAgeYear,year);
    }

    public void enterMonths(String Month){
        driver.clickLocator(petAgeMonths);
        driver.type(petAgeMonths, Month);
    }

    public void clickPetAgeYear(){
        driver.clickLocator(petAgeYear);
    }
    ...
    public boolean isSaveButtonEnabled(){
        driver.pauseExecutionFor(2);
        return driver.isElementEnabled(saveButton);
    }

    public String getUpdatedAge(){
        String updatedAge = driver.getText(getUpdatedAge,"Get the actual updated pet age value");
        return updatedAge;
    }

    public String getExpectedAge(){
        String expectedUpdatedAge = WhistleConstants.UPDATE_AGE+ " years, "+WhistleConstants.UPDATE_AGE+" months";
        return expectedUpdatedAge;
    }

    public String getUpdatedPetFood(){
        String updatedPetFood = driver.getText(getUpdatedPetFood,"Get the actual updated pet food text");
        return updatedPetFood;
    }
    public boolean isPetEditProfileDisplayed(){
        driver.pauseExecutionFor(1);
        return driver.isElementPresent(petEditProfile);
    }
}
